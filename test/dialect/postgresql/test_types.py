...
class _Int4MultiRangeTests:
    ...
    def _data_obj(self):
        return self.extras().Multirange(
            [
                self.extras().NumericRange(1, 2),
                self.extras().NumericRange(3, 5),
                self.extras().NumericRange(9, 12),
            ]
        )
    ...
    def _data_obj(self):
        return self.extras().Multirange(
            [
                ...
                self.extras().DateTimeTZRange(*self.tstzs_delta()),
            ]
        )
...
class Int4MultiRangeCompilationTest(
    _Int4MultiRangeTests, _RangeTypeCompilation
):
    pass


class Int4MultiRangeRoundTripTest(_Int4MultiRangeTests, _RangeTypeRoundTrip):
    pass
...
class Int8MultiRangeCompilationTest(
    _Int8MultiRangeTests, _RangeTypeCompilation
):
    pass


class Int8MultiRangeRoundTripTest(_Int8MultiRangeTests, _RangeTypeRoundTrip):
    pass
...
class NumMultiRangeCompilationTest(_NumMultiRangeTests, _RangeTypeCompilation):
    pass


class NumMultiRangeRoundTripTest(_NumMultiRangeTests, _RangeTypeRoundTrip):
    pass
...
class DateMultiRangeCompilationTest(
    _DateMultiRangeTests, _RangeTypeCompilation
):
    pass


class DateMultiRangeRoundTripTest(_DateMultiRangeTests, _RangeTypeRoundTrip):
    pass
...
class DateTimeMultiRangeCompilationTest(
    _DateTimeMultiRangeTests, _RangeTypeCompilation
):
    pass


class DateTimeMultiRangeRoundTripTest(
    _DateTimeMultiRangeTests, _RangeTypeRoundTrip
):
    pass
